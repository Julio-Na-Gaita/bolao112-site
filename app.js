...
const getAppVersion = () => String(window.APP_VERSION || 'web-1.8.0');
          ...
          <div class="admin-creation-panel space-y-3">
            ...
            <div class="grid grid-cols-1 gap-3">
              ...
              <div class="grid grid-cols-1 gap-3 sm:grid-cols-2">
                ...
                <input id="adminRegulationLatestAppVersion" type="text" class="admin-creation-input" value="${escapeHtml(adminRegulationState.latestAppVersion || "")}" placeholder="1.8.0">
                </div>
                <div>
                  <label class="admin-compact-label">Versão mínima</label>
                  <input id="adminRegulationMinimumAppVersion" type="text" class="admin-creation-input" value="${escapeHtml(adminRegulationState.minimumAppVersion || "")}" placeholder="1.8.0">
                </div>
              </div>
              <div class="grid grid-cols-1 gap-3 sm:grid-cols-2">
                <div>
